...
- Runs 9-11: Run the updated checklist sections 2, 3, 7, 9, 10, 11, 12, 16, and 17 at desktop and mobile widths. For Cypress, use `EWE_NOTE_BASE_URL=http://127.0.0.1:5181/ ELECTRON_RUN_AS_NODE= npx cypress run --config video=false --spec e2e/cypress/tests/ewe-note.cy.ts`.
