...
| `run-2`             | Completed | `packages/ewe-note/src/extensions/ofm-serializer.ts`, `packages/ewe-note/src/editor/markdown.test.ts`, `packages/ewe-note/test-fixtures/obsidian-parity/matrix.json`                                                                                                                                                                                                                                                                                                                                   | `npm run test --workspace @eweser/ewe-note -- --run src/editor/markdown.test.ts src/cli/import-vault.test.ts`, `npm run type-check --workspace @eweser/ewe-note`                                                                                                                                                                                                                                                                                                                                                           | Preserved comments and note/media embeds as source-visible OFM until first-class TipTap nodes own rendering, and aligned parity fixture expectations for aliased heading embeds.                                                                         |
| `run-3`             | Completed | `packages/ewe-note/src/editor/commands.ts`, `packages/ewe-note/src/editor/commands.test.ts`, `packages/ewe-note/src/components/editor-toolbar.tsx`, `packages/ewe-note/src/components/editor-context-menu.tsx`, `packages/ewe-note/src/components/editor-bubble-menu.tsx`, `packages/ewe-note/src/app/components/EnhancedCommandPalette.tsx`, `packages/ewe-note/src/components/tiptap-editor.tsx`, `packages/ewe-note/src/index.css`                                                                  | `npm run test --workspace @eweser/ewe-note -- --run src/editor/commands.test.ts src/editor/markdown.test.ts`, `npm run lint --workspace @eweser/ewe-note -- --max-warnings=0`, `npm run type-check --workspace @eweser/ewe-note`                                                                                                                                                                                                                                                                                           | Added explicit command placements, wired source-mode context through toolbar/bubble/context/slash/palette surfaces, removed context-menu insert truncation, and verified toolbar/slash/palette browser paths.                                            |
| `run-4`             | Completed | `packages/ewe-note/src/editor/input-rules.ts`, `packages/ewe-note/src/components/editor-slash-menu.tsx`, `packages/ewe-note/src/components/tiptap-editor.tsx`, `e2e/cypress/tests/ewe-note.cy.ts`                                                                                                                                                                                                                                                                                                      | `npm run test --workspace @eweser/ewe-note -- --run src/editor/commands.test.ts src/editor/markdown.test.ts`, browser smoke at `http://127.0.0.1:5181/`                                                                                                                                                                                                                                                                                                                                                                    | Slash menu now dismisses with Space/Escape, registry-backed slash commands work in browser, and input rules cover completed tasks, callout starters, highlight/wiki/embed source scaffolds, and table starters.                                          |
...
| `run-6`             | Completed | `packages/ewe-note/src/extensions/callout.ts`, `packages/ewe-note/src/extensions/ofm-serializer.ts`, `packages/ewe-note/src/editor/markdown.test.ts`, `packages/ewe-note/src/index.css`                                                                                                                                                                                                                                                                                                                | `npm run test --workspace @eweser/ewe-note -- --run src/editor/markdown.test.ts src/cli/import-vault.test.ts src/cli/vault-sync.test.ts`, browser smoke at `http://127.0.0.1:5181/`                                                                                                                                                                                                                                                                                                                                        | Preserved custom callout types, kept embeds source-visible to prevent TipTap image-node data loss, and verified callout/embed/comment/footnote source survives source-mode reload.                                                                       |
| `run-7`             | Completed | `packages/ewe-note/src/editor/markdown.test.ts`, `packages/ewe-note/src/cli/vault-sync.test.ts`, `packages/ewe-note/src/editor/input-rules.ts`, `packages/ewe-note/src/index.css`                                                                                                                                                                                                                                                                                                                      | `npm run test --workspace @eweser/ewe-note -- --run src/editor/markdown.test.ts src/cli/vault-sync.test.ts`, `npm run test --workspace @eweser/ewe-note`, `npm run build --workspace @eweser/ewe-note`                                                                                                                                                                                                                                                                                                                     | Tables, Mermaid/math/comment/footnote source are preserved through fixtures/export and exposed through Source Mode; rendered math/Mermaid remain source/opaque in v1 pending a renderer dependency decision.                                             |
| `run-8`             | Completed | `packages/ewe-note/src/components/source-mode-editor.tsx`, `packages/ewe-note/src/components/tiptap-editor.tsx`, `packages/ewe-note/src/components/editor.tsx`, `packages/ewe-note/src/components/frontmatter-editor.tsx`, `packages/ewe-note/src/app/pages/EnhancedEditor.tsx`, `packages/ewe-note/src/app/contexts/NotesContext.tsx`                                                                                                                                                                 | `npm run test --workspace @eweser/ewe-note`, `npm run type-check --workspace @eweser/ewe-note`, browser source-mode smoke at `http://127.0.0.1:5181/`                                                                                                                                                                                                                                                                                                                                                                      | Added raw Markdown Source Mode, stopped prompt-based frontmatter add flow in the inline property editor, preserved frontmatter title/tags/aliases contract through `NotesContext`, and suppressed immediate editor-reserialize loss on source-mode exit. |
| `run-9`             | Completed | `packages/ewe-note/src/components/editor-toolbar.tsx`, `packages/ewe-note/src/components/editor-context-menu.tsx`, `packages/ewe-note/src/components/editor-bubble-menu.tsx`, `packages/ewe-note/src/components/editor-slash-menu.tsx`, `packages/ewe-note/src/index.css`, `docs/ai/testing/ewe-note-ux-feature-audit-checklist.md`                                                                                                                                                                    | `npm run lint --workspace @eweser/ewe-note -- --max-warnings=0`, `npm run type-check --workspace @eweser/ewe-note`, `npm run build --workspace @eweser/ewe-note`, browser smoke at desktop/narrow in the in-app browser                                                                                                                                                                                                                                                                                                    | Added command labels/active states, responsive menu/source-mode/table styling, and updated the manual UX checklist from BlockNote assumptions to TipTap/Obsidian parity expectations.                                                                    |
| `run-10`            | Completed | `packages/ewe-note/src/cli/import-vault.test.ts`, `packages/ewe-note/src/cli/vault-sync.test.ts`, `packages/ewe-note/src/extensions/ofm-serializer.ts`, `packages/ewe-note/test-fixtures/obsidian-parity/*`                                                                                                                                                                                                                                                                                            | `npm run test --workspace @eweser/ewe-note -- --run src/cli/import-vault.test.ts src/cli/vault-sync.test.ts src/editor/markdown.test.ts`, `npm run build --workspace @eweser/ewe-note`                                                                                                                                                                                                                                                                                                                                     | Import/export fixture tests cover aliases, tags, properties, links, embeds, comments, callouts, and footnotes; actual Obsidian desktop open-check remains a manual handoff gap.                                                                          |
| `run-11`            | Completed | `e2e/cypress/tests/ewe-note.cy.ts`, `README.md`, `ARCHITECTURE.md`, `packages/ewe-note/README.md`, `packages/ewe-note/INDEX.md`, `packages/ewe-note/src/INDEX.md`, `packages/ewe-note/src/components/INDEX.md`, `packages/ewe-note/src/extensions/INDEX.md`, `docs/ai/testing/ewe-note-ux-feature-audit-checklist.md`, `docs/ai/plans/2026-05-02-obsidian-editor-parity.md`                                                                                                                            | `npm run lint --workspace @eweser/ewe-note -- --max-warnings=0`, `npm run type-check --workspace @eweser/ewe-note`, `npm run test --workspace @eweser/ewe-note`, `npm run build --workspace @eweser/ewe-note`, `npm run code-index:check`                                                                                                                                                                                                                                                                                  | Updated Cypress selectors away from `.bn-editor`, added source-mode E2E smoke coverage, removed stale current-state BlockNote docs, and kept PR #35 unmerged.                                                                                            |
| Manual retest fixes | Completed | `packages/ewe-note/src/components/editor-toolbar.tsx`, `packages/ewe-note/src/components/tiptap-editor.tsx`, `packages/ewe-note/src/editor/commands.ts`, `packages/ewe-note/src/editor/markdown.ts`, `packages/ewe-note/src/editor/markdown.test.ts`, `e2e/cypress/tests/ewe-note.cy.ts`, `packages/ewe-note/package.json`, `package-lock.json`                                                                                                                                                        | `npm run test --workspace @eweser/ewe-note -- --run src/editor/markdown.test.ts src/cli/import-vault.test.ts src/cli/vault-sync.test.ts src/app/contexts/note-links.test.ts`, `npm run type-check --workspace @eweser/ewe-note`, `npm run build --workspace @eweser/ewe-note`, `EWE_NOTE_BASE_URL=http://127.0.0.1:5181/ ELECTRON_RUN_AS_NODE= npx cypress run --config baseUrl=http://127.0.0.1:5181,video=false --spec e2e/cypress/tests/ewe-note.cy.ts`, Playwright browser smoke at desktop and 390px editor-only mode | Fixed Source Mode discoverability and `Cmd/Ctrl+Shift+S`, replaced hidden Cypress force-click coverage with a visible click, added TipTap table extensions plus Markdown table serialization so `                                                        | A   | B   | `reloads as a readable table instead of`AB12`, and documented the corrected Cypress base URL. |

## Manual Test Handoffs

- Runs 3-4: Start `npm run dev --workspace @eweser/ewe-note -- --host 127.0.0.1`, open `http://127.0.0.1:5181/`, create a note, verify toolbar Text/Insert/List menus, slash `/h2`, `/task`, `/callout`, `/table`, `/math`, and command-palette editor commands. Expected: commands execute through the same registry, slash closes with Escape/Space, and editor content saves after reload.
- Runs 6-7: In Source Mode, create a note with `> [!warning]+`, `![[image.png|320]]`, a table, a Mermaid fence, `$inline$`, `$$block$$`, `%%comment%%`, and `[^footnote]`. Expected: unsupported syntax remains source-visible and exportable; math and Mermaid are preserved but not richly rendered in v1.
- Run 8: Add frontmatter properties through the inline property editor and Source Mode, including `tags`, `aliases`, strings, numbers, booleans, dates, and lists. Expected: header title uses frontmatter title first, aliases resolve for wiki links, and raw YAML/source edits survive mode switches.
- Runs 9-11: Run the updated checklist sections 2, 3, 7, 9, 10, 11, 12, 16, and 17 at desktop and mobile widths. For Cypress, use `EWE_NOTE_BASE_URL=http://127.0.0.1:5181/ ELECTRON_RUN_AS_NODE= npx cypress run --config baseUrl=http://127.0.0.1:5181,video=false --spec e2e/cypress/tests/ewe-note.cy.ts`.
- Manual retest fix pass: Verify Source Mode through the visible toolbar button and `Cmd/Ctrl+Shift+S`; create a note containing `| A | B |\n| - | - |\n| 1 | 2 |`, switch to Live Preview, reload, and confirm it remains a readable table. Desktop browser proof used the default editor surface; narrow proof used 390px editor-only pane mode because mode 3 intentionally keeps sidebar/list/editor as separate panes.

## Self-Reflection / Instruction Improvements

- The documented runtime-orientation path in `AGENTS.md` pointed at `~/.codex/skills/...`, but this machine had the repo-local skill at `.codex/skills/...`; future runs should try the repo-local path before treating orientation as blocked.
- Do not render OFM media embeds through Markdown image syntax unless a registered TipTap image/media node can round-trip them. Source-visible preservation is safer than attractive but lossy preview.
