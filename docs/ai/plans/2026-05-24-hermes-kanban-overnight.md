...
- **Browser checkpoint**: `focused`
- **Deliverable**:
  - Production proof using a secret-provided tester account and synthetic notes.
- **Files**:
  - Plan execution summary only unless code fixes are required.
- **Steps**:
  ...
  - [ ] Verify MCP read/search and Agent Journal write boundaries.
- **Tests**:
...
- **Browser checkpoint**: `none`
- **Deliverable**:
  - Smaller grilled tasks for DB README backlog runs 4+.
- **Files**:
...
- **Verification**:
  - Each task has a clear write scope and PR acceptance criteria.
- **Manual test handoff**:
...
| `run-4` | In progress | Hermes Kanban task `t_c0b8f0c3`                                                                           | Pending                                                                                                                                                                                                                                                                                                       | Local dogfood gate is running under `eweser-coder` in `/home/jacob/code/eweser-db.worktrees/hermes-local-dogfood-gate`; superseded root-checkout task `t_206b1a83` is blocked.                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| `run-5` | Blocked     | Hermes Kanban task `t_645b46df`                                                                           | Pending                                                                                                                                                                                                                                                                                                       | Blocked until local dogfood passes and secret-provided tester credentials are available.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| `run-6` | Blocked     | Hermes Kanban task `t_6a3ad371`                                                                           | Pending                                                                                                                                                                                                                                                                                                       | Blocked until local dogfood identifies concrete Ewe Note navigation/presentation gaps.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| `run-7` | Blocked     | Hermes Kanban task `t_53bd7bff`                                                                           | Pending                                                                                                                                                                                                                                                                                                       | Blocked until local and production dogfood evidence exists.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| `run-8` | Blocked     | Hermes Kanban task `t_4fe8f025`                                                                           | Pending                                                                                                                                                                                                                                                                                                       | Blocked until dogfood gates and site promise reconciliation complete.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
