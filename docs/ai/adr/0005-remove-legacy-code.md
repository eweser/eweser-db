...
| Item                                           | Reason                                                                                           |
| ---------------------------------------------- | ------------------------------------------------------------------------------------------------ |
| `packages/auth-server/`                        | Old Next.js + Supabase auth server, replaced by `packages/auth-server-hono/` and `packages/app/` |
...
- The current auth surface is `packages/auth-server-hono` plus `packages/app`.
