...
export default function SignOutPage() {
  ...
  useEffect(() => {
    const signOut = async () => {
      ...
      // clear indexedDb
      try {
        // I'm not using indexedDB for anything else here, so this is more convenient, but if you want to only delete EweserDB indexedDB databases, instead use the logoutAndClear() method, of call room.indexedDBProvider?.destroy(); on each room
