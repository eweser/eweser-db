            ...
            results: [
              {
                ...
                collectionKey: 'notes',
                userId: null,
                documentData: { title: 'Local Weather Notes', text: 'Cloudy with a chance of meatballs' },
              ...
              },
              {
                ...
                collectionKey: 'notes',
                userId: null,
                documentData: { title: 'Rainy Day Plans', text: 'Indoor activities for wet weather' },
                updatedAt: new Date().toISOString(),
                rank: 0.82,
              },
            ],
                ...
                results: [
                  {
                    ...
                    collectionKey: 'notes',
                    userId: null,
                    documentData: { title: 'Peer A Storm Tracker', text: 'Hurricane season is starting' },
                    updatedAt: new Date().toISOString(),
                    rank: 0.74,
                  },
                ],
                ...
                results: [
                  {
                    ...
                    collectionKey: 'notes',
                    userId: null,
                    documentData: { title: 'Peer B Climate Data', text: 'Temperature records from 2025' },
                    updatedAt: new Date().toISOString(),
                    rank: 0.68,
                  },
                ],
            ...
            results: [
              {
                ...
                collectionKey: 'notes',
                userId: null,
                documentData: { title: 'Local Fallback', text: 'This always works' },
                updatedAt: new Date().toISOString(),
                rank: 0.9,
              },
            ],
                ...
                results: [
                  {
                    ...
                    collectionKey: 'notes',
                    userId: null,
                    documentData: { title: 'Peer B Works', text: 'This peer responded fine' },
                    updatedAt: new Date().toISOString(),
                    rank: 0.71,
                  },
                ],
